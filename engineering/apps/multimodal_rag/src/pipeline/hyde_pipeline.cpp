...
void HyDEPipeline::set_hnsw_retriever(std::shared_ptr<mmrag::HNSWRetriever> retriever) {
...
std::vector<mmrag::RetrievalResult> HyDEPipeline::retrieve_with_hypotheses(
...
std::vector<mmrag::RetrievalResult> HyDEPipeline::retrieve_with_single_hypothesis(
