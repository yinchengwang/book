...
VectorSearchTool::VectorSearchTool(std::shared_ptr<mmrag::Retriever> retriever, int top_k)
...
BM25SearchTool::BM25SearchTool(std::shared_ptr<mmrag::Retriever> retriever, int top_k)
    : retriever_(std::move(retriever)), top_k_(top_k) {
}
...
GraphSearchTool::GraphSearchTool(std::shared_ptr<mmrag::GraphRetriever> graph_retriever, int top_k)
...
LLMGenerateTool::LLMGenerateTool(std::shared_ptr<mmrag::LLMService> llm_service)
