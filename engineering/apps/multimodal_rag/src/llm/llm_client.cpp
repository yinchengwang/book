...
std::string LLMClient::generate(const std::string& prompt) {
    return "LLM stub: CURL not available, cannot generate response";
}
...
std::string LLMClient::post_json(const std::string& path, const std::string& body) {
    return "{}";
}

std::string LLMClient::get_json(const std::string& path) {
    return "{}";
}
