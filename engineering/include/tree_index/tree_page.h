 ...
 * tree_page.h
 *
 * Shared page layout used by tree index persistence.
 * The on-disk format uses fixed-size pages with:
 *   - a page header at the front
 *   - a slot directory growing forward
 *   - variable-length payload tuples packed from the end backward
 */

#ifndef TREE_INDEX_PAGE_H
#define TREE_INDEX_PAGE_H
